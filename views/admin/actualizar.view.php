...
<div class="register">
    ...
    <div class="row row-eq-height">
        ...
        <div class="col-lg-10 table-responsive" id="actualizar" style="display:<?= $accion1;?>;">
            ...
            <thead class="titulo-tabla">
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        <td colspan="4">
                            <input type="text" name="usuario" value="<?= utf8_decode($variables['usuario']);?>" placeholder="USUARIO" class="form-control" required>
                        </td >
                        <td colspan="4">
                            <input type="password" name="clave" value="<?= $variables['clave'];?>" placeholder="CONTRASEÑA" class="form-control" required>    
                        </td>
                    </tr>
                </tbody>
                <thead class="titulo-tabla">
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        <td colspan="2">
                            <input type="text" name="nombres" value="<?= utf8_decode($variables['nombres']);?>" placeholder="NOMBRES" class="form-control" required>
                        </td >
                        <td colspan="2">
                            <input type="text" name="apellidos" value="<?= utf8_decode($variables['apellidos']);?>" placeholder="APELLIDOS" class="form-control" required>    
                        </td>
                        <td colspan="2">
                            <input type="text" name="cedula" value="<?= $variables['cedula'];?>" placeholder="CEDULA" class="form-control" required>
                        </td>
                        <td>
                            <input type="text" name="edad" value="<?= $variables['edad'];?>" placeholder="EDAD" class="form-control" required>
                        </td>
                        <td colspan="2">
                            <input type="text" name="nacionalidad" value="<?= $variables['nacionalidad'];?>" placeholder="NACIONALIDAD" class="form-control" required>
                        </td>
                    </tr>
                    <tr class="subtitulo-tabla">
                    ...
                    <tr>
                    	...
                    	?>
                        <td colspan="2">
                            <input type="date" name="fecha_nacimiento" value="<?= $fecha_n[0] .'-'. $fecha_n[1] .'-' . $fecha_n[2] ;?>" placeholder="FECHA NACIMIENTO" class="form-control" required>
                        </td>
                        <td colspan="2">
                            <input type="text" name="lugar_nacimiento" value="<?= utf8_decode($variables['lugar_nacimiento']);?>" placeholder="NACIÓ" class="form-control" required>
                        </td>
                        <td colspan="2">
                        ...
                        <td colspan="2">
                            <input type="text" name="telefono" value="<?= $variables['telefono'];?>" placeholder="TELEFONO" class="form-control" required>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        ...
                        <td colspan="3">
                            <input type="text" name="universidad" value="<?= utf8_decode($variables['universidad']);?>" placeholder="UNIVERSIDAD" class="form-control" required>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr class="text-datos">
                        <td colspan="8">
                            <input type="text" name="direccion" value="<?= utf8_decode($variables['direccion']);?>" placeholder="DIRECCIÓN" class="form-control" required>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        ...
                        <td colspan="2">
                            <input type="email" name="email" value="<?= utf8_decode($variables['email']);?>" placeholder="E-MAIL" class="form-control" required>
                        </td>
                    </tr>
                </tbody>
        ...
        <!--++++++++++++++++++++++++++++++++++++++++++++
         ...
         <div class="col-lg-9 table-responsive" style="display:<?= $accion3;?>;" id="actualizarFamiliares">
            ...
            <form action="actualizarFamiliares" method="post">
                ...
                <table class="table">
                    <thead class="titulo-tabla">
                    <tr>
                        <td colspan="6">CARGA FAMILIAR DE <?= utf8_decode($variables['nombres']).' '. utf8_decode($variables['apellidos'])?>
                            
                        </td>
                        <td align="right">
                            <a onClick='document.getElementById("actualizarFamiliares").style.display = "none"' style="cursor: pointer; ">
                                <span class="fas fa-times"></span>
                            </a>
                        </td>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        <td colspan="2">
                        	...
                        	<input type="text" class="form-control" name="nombre_fam<?=$i+1?>" value="<?= utf8_decode($familia['nombre']);?>" required>
                        		
                        </td>
                        <td colspan="2">
                        	<input type="text" class="form-control" name="apellido_fam<?=$i+1?>" value="<?= utf8_decode($familia['apellido']);?>" required>
                        </td>
                        <td colspan="2">
                        	<input type="text" class="form-control" name="parentesco_fam<?=$i+1?>" value="<?= utf8_decode($familia['parentesco']);?>" required>
                        </td>
                        <td colspan="2">
                        	<input type="text" class="form-control" name="telefono_fam<?=$i+1?>" value="<?= utf8_decode($familia['telefono']);?>" required>
                        </td>
                    </tr>
                        <?php      
                            endfor;
            	...
            	<form action="actualizarCuota" method="post">
	                ...
	                <thead>
	                    <tr class="titulo-tabla">
	                        <td colspan="10">ACTULIZAR CUOTAS - <?= utf8_decode($variables['nombres'].' '. $variables['apellidos'])?>
	                ...
	                <tbody>
	                    ...
	                    <tr class="text-datos">
                        	...
                        	<input type="hidden" name="id<?=$i+1?>" value="<?= $cuota['id'];?>" >
	                    	 ...
	                    	 <td class="h3"><?=$i+1?></td>
	                         <td colspan="2">
	                         	<input type="text" class="form-control" name="year<?= $i+1?>" value="<?=$cuota['year']?>" required>
	                         </td>
	                        <td colspan="4">
