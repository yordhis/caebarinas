        ...
        <div class="col-lg-8" id="formCuota" style="display: none;">
            ...
            <form action="setCuotas" method="post">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td colspan="8">REGISTRO DE CUOTAS</td>
                            <td align="right">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="4">
                            <input type="text" name="cedula" class="form-control" placeholder="CEDULA DEL ABOGADO" required>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="8">
            ...
            <thead class="titulo-tabla">
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        ...
                        <td colspan="2">
                            <input type="text" name="nacionalidad" placeholder="NACIONALIDAD" class="form-control" required>
                        </td>
                    </tr>
                    <tr class="subtitulo-tabla">
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="date" name="fecha_nacimiento" placeholder="FECHA NACIMIENTO" class="form-control" required>
                        </td>
                        <td colspan="2">
                            <input type="text" name="lugar_nacimiento" placeholder="NACIÓ" class="form-control" required>
                        </td>
                        <td colspan="2">
                            <input type="text" name="estado_civil" placeholder="ESTADO CIVIL" class="form-control" required>
                        </td>
                        <td colspan="2">
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        ...
                        <td colspan="3">
                            <input type="text" name="universidad" placeholder="UNIVERSIDAD" class="form-control" required>
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="col-lg-8 table-responsive" style="display: none;" id="formFamiliar">
            ...
            <form action="setFamiliares" method="post">
                ...
                <table class="table">
                    <thead class="titulo-tabla">
                    <tr>
                        <td colspan="8">DATOS FAMILIARES</td>
                            <td align="right">
                ...
                <tbody>
                    ...
                    <tr class="text-datos">
                        <td><?= $i+1; ?></td>
                        <td colspan="2">
                            <input type="text" id="input1" name="nombre_fam<?=$i+1?>" placeholder="NOMBRES" class="form-control" >
                            
                        </td>
                        <td colspan="2">
                            <input type="text" id="input2" name="apellido_fam<?=$i+1?>" placeholder="APELLIDOS" class="form-control">
                        </td>
                        <td colspan="2">
                            <input type="text" id="input3" name="parentesco_fam<?=$i+1?>" placeholder="PARENTESCO" class="form-control">
                        </td>
                        <td colspan="2">
                            <input type="phone" id="input4" name="telefono_fam<?=$i+1?>" placeholder="TELEFONO" class="form-control">
                        </td>
                    </tr>
                        <?php
                            endfor;
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="8">
                            <button class="btn btn-lg btn-success buttom" id="boton" align="center">REGISTRAR</button>
                        </td>
                    </tr>
                </tfoot>
                </table>
