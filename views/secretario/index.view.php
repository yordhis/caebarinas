...
<div class="register">
    ...
    <?php       
        ...
        <div class="col-lg-10 table-responsive" id="tablaAbogado" style="display:<?= $accion1;?>;">
            <table class="table">
                <thead class="titulo-tabla">
                    <tr>
                        <td colspan="8">DATOS PERSONALES</td>
                        <td align="right">
                            <a onClick='document.getElementById("tablaAbogado").style.display = "none"' style="cursor: pointer; ">
        ...
        <!--++++++++++++++++++++++++++
            ...
            +++++++++++++++++++++++++++-->
        <div class="col-lg-8 table-responsive" id="tablaPago" style="display:<?= $accion3?>;">
            <table class="table">
            <thead class="titulo-tabla">
                    <tr>
                        <td colspan="6">PAGOS DE <?= $variables['nombres']?> <span id="mes"></span></td>
                        <td align="right">
                            <a onClick='document.getElementById("tablaPago").style.display = "none"' style="cursor: pointer; ">
                                <span class="fas fa-times"></span>
                            </a>
                        </td>
                    </tr>
